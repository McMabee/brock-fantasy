...
- Accessibility: keyboard-only web, focus order, VoiceOver/TalkBack smoke tests, text resizing,
  ...
  dashboard, league, draft, league setup, account, notifications, ingestion incident,
  provider-mapping, and replay preview views at desktop and mobile web sizes; they do not replace the
  manual or physical-device checks in this list.
